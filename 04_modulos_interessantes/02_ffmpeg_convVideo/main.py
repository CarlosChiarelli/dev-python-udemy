"""Conversor de vídeo mais famoso."""
...
crf = '-crf 23'  # controla qualidade da imagem
preset = '-preset ultrafast'
codec_audio = '-c:a aac'
bitrate_audio = '-b:a 320k'
debug = '-ss 00:00:00 -to 00:00:10'  # controla intervalo de tempo
debug = ''
